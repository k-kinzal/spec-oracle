...
ztd-queryを見ていただくとわかると思うのですが、契約や性質、テストでの部分的な保証という感じでそれぞれの層で実装の保証をしている形ですね。ztd-queryはライブラリにないですがVRTやSchema、DB ContractやConsumer based Contract TestingやLean4やAlloyなどの形式手法もそうですね。そういった...
