...
GOAL:
- Round 43 artifact/reproducibility acceptance gate.
...
- Focus:
  1) deterministic replay fixed inputs/hash conditions
  2) graceful_may consistency across manuscript/README/logs
  3) automation evidence tr...
