...
\item[\textbf{RQ5}] Can extraction adequacy be decomposed into sound-only and complete-only forms?
\item[\textbf{RQ6}] Can the real-OSS extraction pipeline be executed reproducibly (pipeline executability)?
\end{enumerate}
...
RQ5 by Theorem~\ref{thm:adequacy}; RQ6 is partially addressed by the
source-locked extraction pipeline executability demo, with extraction
soundness/completeness left as future work.
