...
//!
//! After a Node is accepted, the Evidence Consumer *captures* what the locator points
//! at **at Delivery execution time** and hashes it, so grounding can later be checked for
